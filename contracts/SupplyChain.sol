...
contract supplyChain {
    ...
    function addProduct(uint32 _ownerId, string memory _modelNumber,  string memory _partNumber,
        string memory _serialNumber, uint32 _productCost) public returns (uint32) {
        
        // Here replace this if with require
    ...
    // The new owner can only run if the owner of the item is sending the transaction
